...
local PlayerPermissionsModule = loadstring(game:HttpGet("https://raw.githubusercontent.com/dawnuwu/2017CoreGui/main/Scripts/Modules/PlayerPermissionsModule.lua"))()
local StatsUtils = loadstring(game:HttpGet("https://raw.githubusercontent.com/dawnuwu/2017CoreGui/main/Scripts/Modules/Stats/StatsUtils.lua"))()
...
if not NON_CORESCRIPT_MODE and not InputService.VREnabled then
  playerDropDownModule = loadstring(game:HttpGet("https://raw.githubusercontent.com/dawnuwu/2017CoreGui/main/Scripts/Modules/PlayerDropDown.lua"))()
      ...
      pcall(function()
          if not NON_CORESCRIPT_MODE and sendingPlayer == PlayersService.LocalPlayer then
            ...
            if string.lower(chattedMessage) == "/console" then
              local devConsoleModule = nil --TODO: im fucking lazy make this work later. require(RobloxGui.Modules.DeveloperConsoleModule)
