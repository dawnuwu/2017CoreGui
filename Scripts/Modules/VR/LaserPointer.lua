...
local Utility = loadstring(game:HttpGet("https://raw.githubusercontent.com/dawnuwu/2017CoreGui/main/Scripts/Modules/Settings/Utility.lua"))() --todo: use common utility module when it's done
