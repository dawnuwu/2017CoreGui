...
local RobloxGui = CoreGui:WaitForChild("SkibidiRobloxGui")
...
local LaserPointer = loadstring(game:HttpGet("https://raw.githubusercontent.com/dawnuwu/2017CoreGui/main/Scripts/Modules/VR/LaserPointer.lua"))()
