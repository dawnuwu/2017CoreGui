...
if backpackUseGridLayoutEnabled then
	return loadstring(game:HttpGet("https://raw.githubusercontent.com/dawnuwu/2017CoreGui/main/Scripts/Modules/BackpackScriptV2.lua"))()
end
...
local function OnVREnabled(prop)
	if prop == "VREnabled" then
		...
		if IsVR then
			...
			local Healthbar = loadstring(game:HttpGet("https://raw.githubusercontent.com/dawnuwu/2017CoreGui/main/Scripts/Modules/VR/Healthbar3D.lua"))()
