...
do
	tenFootInterfaceEnabled = loadstring(game:HttpGet("https://raw.githubusercontent.com/dawnuwu/2017CoreGui/main/Scripts/Modules/TenFootInterface.lua"))():IsEnabled()
end
