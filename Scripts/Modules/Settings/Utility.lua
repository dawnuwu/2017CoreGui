...
local RobloxGui = CoreGui:FindFirstChild("SkibidiRobloxGui")
...
if not enablePortraitMode then
	return loadstring(game:HttpGet("https://raw.githubusercontent.com/dawnuwu/2017CoreGui/main/Scripts/Modules/Settings/UtilityOld.lua"))()
end


------------------ VARIABLES --------------------
local tenFootInterfaceEnabled =  loadstring(game:HttpGet("https://raw.githubusercontent.com/dawnuwu/2017CoreGui/main/Scripts/Modules/TenFootInterface.lua"))():IsEnabled()
...
local function ShowAlert(alertMessage, okButtonText, settingsHub, okPressedFunc, hasBackground)
	...
	local function onVREnabled(prop)
		...
		if VRService.VREnabled then
			Panel3D = loadstring(game:HttpGet("https://raw.githubusercontent.com/dawnuwu/2017CoreGui/main/Scripts/Modules/VR/Panel3D.lua"))()
