...
local function Initialize()
	local settingsPageFactory = loadstring(game:HttpGet("https://raw.githubusercontent.com/dawnuwu/2017CoreGui/main/Scripts/Modules/Settings/SettingsPageFactory.lua"))()
